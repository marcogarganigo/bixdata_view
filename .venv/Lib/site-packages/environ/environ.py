...
class Env:
    ...
    Usage:::
        ...
        # Take environment variables from .env 2 file
        environ.Env.read_env(os.path.join(BASE_DIR, '.env 2'))
    ...
    def read_env(cls, env_file=None, overwrite=False, encoding='utf8',
                 **overrides):
        r"""Read a .env 2 file into os.environ.
        ...
        * https://wellfire.co/learn/easier-12-factor-django
        ...
        :param env_file: The path to the ``.env 2`` file your application should
