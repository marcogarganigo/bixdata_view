...
urlpatterns = [
    ...
    path('block_records_custom/', alpha.get_block_records_custom, name='block_records_custom'),
    ...
    path('generate_eml_gasolio/', alpha.generate_eml_gasolio, name='generate_eml_gasolio'),
    path('update_profile_pic/', alpha.update_profile_pic, name='update_profile_pic'),
    ...
    path('pitservice_sollecitaticket/', alpha.pitservice_sollecitaticket, name='pitservice_sollecitaticket')
